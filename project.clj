...
(defproject saya-script "0.1.0-SNAPSHOT"
  ...
  :cljsbuild      {:builds
                   {:main
                    {:source-paths ["src" "src_main"]
                     :figwheel     {:on-jsload saya-script.main.init/on-figwheel-reload!}
                     :compiler     {:main           saya-script.main.init
                    ...
                    {:source-paths ["src" "src_front"]
                     :figwheel     {:on-jsload saya-script.init/start-front!}
                     :compiler     {:main           saya-script.init
